...
return {
    ...
    },
    {
        ...
        opts = {
            ...
            keymap = {
                ["<C-y>"] = { "select_and_accept", override = true },
            },
            completion = {
    ...
    },
    {
        ...
        opts = {
            ...
            servers = {
                luau_lsp = { enabled = true },
                gitlab_ci_ls = { enabled = false },
                        ...
                        settings = {
                            nixd = {
                                ...
                                options = {
                                    nixos = {
                                        expr =
                                        '(builtins.getFlake "/home/chiko/NixOS").nixosConfigurations.Default.options',
                                    },
                                    -- home_manager = {
                                    --     expr =
                                    --     '(builtins.getFlake ("git+file://" + toString ./.)).homeConfigurations.Default.options',
                                    -- },
                                },
                            },
                        },
