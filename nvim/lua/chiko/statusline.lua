ChikoWriteCount = ChikoWriteCount or 0
...
local M = {}
M.on_write = function()
    ChikoWriteCount = ChikoWriteCount + 1
end
M.set_write = function(count)
    ChikoWriteCount = count
end
local autocmd = vim.api.nvim_create_autocmd
local augroup = vim.api.nvim_create_augroup
local status_group = augroup('ChikoStatusLine', {})
autocmd('ChikoStatusLineCmd', {
    group = status_group,
    pattern = '*',
    callback = function()
        M.on_write()
